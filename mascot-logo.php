...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            var titles = ["Mascot Logo | WEBHYTE", "Mascot Logo", "Abstract Logo", "3D Logo", "Logo Illustration"];
            var index = 0;
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Mascot Logo</h6>
                    <h1>Custom Mascot Logo Design</h1>
                    <p>
                    Uplift your brand's appeal with our unbeatable mascot logo design services! With mascot logos, 
                    we craft stories that spark connections between your brand and your audience.                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/mascot-banner.png" class="img-fluid logo-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/mascot-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Why Web Hyte For Your</span> <br>Next Mascot Logo?</h1>
                <p>We don't believe in templates or cookie-cutter solutions. Your brand is unique, and your mascot logo should be too. With this approach in our minds, our seasoned artists weave magic with every digital stroke, ensuring your mascot is unparalleled.</p>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Mascot Logo Design</span></h1>
