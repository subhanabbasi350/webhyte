...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            var titles = ["Website | WEBHYTE", "Ecommerce Website", "Business Website", "Landing Pages" ,"Responsive"];
            var index = 0;
...
<!-- banner start -->
<!-- banner start -->
<section class="responsive-website website-banner bg__detail">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Sales-oriented Ecommerce</h6>
                    <h1>Grow 2X with eCommerce<br> Website Design.</h1>
                    <p>
                    It is difficult to compete in the e-commerce industry and it 
is becoming more and more difficult for online stores to be 
successful online. With our e-commerce packages, we help 
your business reach the top.
                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/website-banner.png" class="img-fluid website-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/website-section.png" class="img-fluid web-section-image" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Great web interfaces for  </span> <br>Businesses around the world</h1>
                <p>Our family of WordPress web designers and developers, ecommerce web designers, and just about any website design help us hire some of the best web design and development companies online. Need something different, like custom WordPress web designs? Look no further. Our team of WordPress web designers is enough to detect your project. In addition, our WordPress web designers also oversee web maintenance after project implementation.</p>
        ...
        <div class="row">
            <div class="col-lg-12 portfolio-text-sec">
                <div class="portflio-heading text-center">
                    <h1>Premium Solution for<span> Web Creation</span></h1>
                    <p>We help organizations, small businesses, startups and entrepreneurs grow with<br>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Website Design</span></h1>
                    ...
                    <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/1.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/2.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/3.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/4.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/5.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/6.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/7.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/8.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/9.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/10.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/11.jpg">
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfolioecommerce" href="assets/images/portfolio/website/full/12.jpg">
