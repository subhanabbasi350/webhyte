...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            var titles = ["Logo Design | WEBHYTE", "Mascot Logo", "Abstract Logo", "3D Logo", "Logo Illustration"];
            var index = 0;
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Get Unique and</h6>
                    <h1>Logo That Pictures<br> Your Brand.</h1>
                    <p>
                    Custom logo creation we know that a creatively designedlogo can help your business or product in a meaningful way.
                    </p>
                    <div class="banner-btn-wrap">
                        <a href="#footer-form" class="btn-style-2 banner-btn-1">Avail Flat 70% Off</a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/logo-banner.png" class="img-fluid logo-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/logo-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Behind Every Great </span> <br>Brand
                there is a Great Logo</h1>
                <p>Your company logo is really crucial for your brand. It is one of the most
important building blocks of any brand. In fact, you represent and
communicate your company's values and ideals to your partners, customers
and other stakeholders. At Website Design Avenue , we provide exceptional
logo details that not only speaks volumes about our expertise, but also gives
our clients' brands the edge they need to stand out in the market. #</p>
...
<section class="portfolio spacing__x top">
        ...
        <div class="row">
            <div class="col-lg-12 portfolio-text-sec">
                <div class="portflio-heading text-center">
                    <h1>Premium Solution for<span> Logo Creation</span></h1>
                    <p>We help organizations, small businesses, startups and entrepreneurs grow <br>with
                    personalized solutions focused on results.</p>
                </div>
            </div>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Iconic Logo Design</span></h1>
    ...
    <div id="hiddenRows" style="display: none;">
        ...
        <!-- Two additional rows of portfolio items -->
                ...
                <div class="col-lg-12">
                    <div class="items">
                        <ul>
                            ...
                            <li><a href="#" class="btn-style-2 request-btn">Request a Quote <span class="moving-circle"></span></a></li>
