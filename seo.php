...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            var titles = ["SEO | WEBHYTE", "Search", "Engine", "Optimizaion"];
            var index = 0;
...
<!-- banner start -->
<!-- banner start -->
<section class="responsive-website bg__detail markeing-banner">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Search Engine Optimization</h6>
                    <h1>Ramp Up SEO Game</h1>
                    <p>
                    It's time to bring your business front and center with our professional SEO 
agency services! We uphold effective search engine optimization to drive 
higher organic searches and let the world know what you have to offer!
                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/seo-banner.png" class="img-fluid marketing-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/seo-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Professional SEO Services</span> Professional SEO Services</h1>
                <p>We've been providing SEO services for a few years now and keep an eye out for the latest SEO updates to keep our game going. Our expert teams know exactly how to improve your website ranking based on industry best practices. By helping many businesses achieve the best search engine results, we can ensure the best results. Contact us today and we'll make sure your website is in the top three searches on Google.</p>
