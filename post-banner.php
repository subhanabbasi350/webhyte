        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Post & Banner Ads</h6>
                    <h1>Power Your Brand with High Fidelity Vissuals </h1>
                    <p>
                    Our creative designers provide you with extremely stylish marketing material that impresses the customer.
                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/post-banner.png" class="img-fluid logo-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/post-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Attract the Online Crowd with</span> Engaging Banners</h1>
                <p>Want to advertise a sale, a discount season, or a new arrival? That is what our custom banner ad designs are for, and we design them around the product, service, and the brands providing it!</p>
        ...
        <div class="row">
            <div class="col-lg-12 portfolio-text-sec">
                <div class="portflio-heading text-center">
                    ...
                    <p>Use high-quality, eye-catching visuals like photos, illustrations, and graphics to make the banner stand out</p>
                </div>
            </div>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Post & Banner Ads</span></h1>
                    ...
                    <ul class="responsive-slider">
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/1.png">
                                    <img src="assets/images/portfolio/post/1.png">
                                </a>
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/2.png">
                                    <img src="assets/images/portfolio/post/2.png">
                                </a>
                                <div class="hover-effect">
                                    <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/2.png">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/3.png">
                                    <img src="assets/images/portfolio/post/3.png">
                                </a>
                                <div class="hover-effect">
                                    <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/3.png">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/4.png">
                                    <img src="assets/images/portfolio/post/4.png">
                                </a>
                                <div class="hover-effect">
                                    <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/4.png">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                        ...
                        <li>
                            <div class="portfolio-item">
                                <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/5.png">
                                    <img src="assets/images/portfolio/post/5.png">
                                </a>
                                <div class="hover-effect">
                                    <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/5.png">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                            ...
                            <div class="portfolio-item">
                                <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/6.png">
                                    <img src="assets/images/portfolio/post/6.png">
                                </a>
                                <div class="hover-effect">
                                    <a data-fancybox="portfoliologo" href="assets/images/portfolio/post/6.png">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
