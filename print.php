        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Print Collateral</h6>
                    <h1>ERevamp Your Marketing Efforts With Our Trusted Services!</h1>
                    <p>
                    Web Hyte allows brands to enjoy beautifully crafted material 
featuring concise messaging to influence preferences. What’s 
more, businesses of every size can benefit from the marketing 
collateral agency services for robust promotions. 
                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/print-banner.png" class="img-fluid logo-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/print-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Hire Us to Unleash Your Business’s True Potential!</h1>
                <p>You don’t have to concern yourself with tedious marketing collateral efforts. We at Logomentary accelerate your brand’s growth efforts and ultimately help you meet your sales goals.</p>
        ...
        <div class="row">
            <div class="col-lg-12 portfolio-text-sec">
                <div class="portflio-heading text-center">
                    <h1>Premium Quality Marketing Collateral Design Solution</span></h1>
                    <p>At Website Design Avenue , we help our clients achieve the goal with excellent marketing collateral design serviceassisting you in making lasting impression at first sight.</p>
                </div>
            </div>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Print Collateral</span></h1>
