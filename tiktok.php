        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    ...
                    <h1>Expand
                    Your Digital Footprint</h1>
                    <p>
                    TikTok has over 1.5 billion active monthly users. With our 
TikTok marketing services, you or your brand can easily 
reach them, as our creative geniuses have your back.
                    </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/tiktok-banner.png" class="img-fluid tiktok-banner-image" alt="Responsive Banner">
            </div>
        </div>
    </div>
</section>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/tiktok-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>Why TikTok?</h1>
                <p>With 1.5 billion active users, businesses have a great opportunity to reach a large audience on TikTok. With such a great number, your chances to reach a bigger audience become higher, saving you a lot of your marketing expenses.</p>
        ...
        <div class="row">
            <div class="col-lg-12 portfolio-text-sec">
                <div class="portflio-heading text-center">
                    <h1>Perks Of Working with Us</span></h1>
                    <p>Each brand or individual has a unique tale to show, and we're here to help you do it as successfully as possible.</p>
                </div>
            </div>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Tiktok</span></h1>
                    ...
                    <li>
                            ...
                            <video width="305" height="240"    autoplay loop poster="assets/images/portfolio/tiktok/1.png">
                                 <source src="assets/images/portfolio/tiktok/1.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>
                        <li>
                            <div class="portfolio-item">
                            <video width="305" height="240"   autoplay loop poster="assets/images/portfolio/tiktok/2.png">
                                 <source src="assets/images/portfolio/tiktok/2.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>                        
                        <li>
                            <div class="portfolio-item">
                            <video width="305" height="240"   autoplay loop poster="assets/images/portfolio/tiktok/3.png">
                                 <source src="assets/images/portfolio/tiktok/3.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>        
