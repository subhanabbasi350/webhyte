...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            var titles = ["Video Animation | WEBHYTE", "Video Animation", "3D Logo Animation"];
            var index = 0;
...
<!-- banner start -->
<!-- banner start -->
<section class="video-website logo-banner bg__detail">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="inner-banner-content">
                    <h6>Video Animation</h6>
                    <h1>Our Animated Videos Tell Your Story!</h1>
                    <p>
                    Don’t wait around! Get us to create visually compelling animated videos today!</p>
...
<section class="content-sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="assets/images/elements/video-section.png" class="img-fluid" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 content-section">
                <h1><span>With great animated videos,</span>you get the traction you need</h1>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 portfolio-text-sec">
                ...
                <h1>Peet Into Our Creative <span> Video Gallery</span></h1>
                    <p>We put the needs and preferences of our clients above all to deliver the best animated videos. From story-boarding to character creation, we can perform with precision and ease. Ready to discover how you can boost rankings and become the next market leader?</p>
                </div>
            </div>
    ...
    <div class="conatiner porfolio-sec logo-portfolio">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="iconic-logo-heading">Video Animation</span></h1>
                    ...
                    <ul class="responsive-slider">
                        <li>
                            ...
                            <video width="305" height="240"    autoplay loop poster="assets/images/portfolio/video animation/1.png">
                                 <source src="assets/images/portfolio/video animation/1.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>
                        <li>
                            <div class="portfolio-item">
                            <video width="305" height="240"   autoplay loop poster="assets/images/portfolio/video animation/2.png">
                                 <source src="assets/images/portfolio/video animation/2.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>                        
                        <li>
                            <div class="portfolio-item">
                            <video width="305" height="240"   autoplay loop poster="assets/images/portfolio/video animation/3.png">
                                 <source src="assets/images/portfolio/video animation/3.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>
                        <li>
                            <div class="portfolio-item">
                            <video width="305" height="240"   autoplay loop poster="assets/images/portfolio/video animation/4.png">
                                 <source src="assets/images/portfolio/video animation/4.mp4" type="video/mp4">
                            </video>
                            </div>
                        </li>                        
