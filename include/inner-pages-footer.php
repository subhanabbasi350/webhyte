        ...
        <div class="row footer-row">
            <div class="col-lg-5 col-md-6">
                <div class="footer-text-sec">
                    ...
                    <a class="contact-info footer-blue-text-email" href="mailto:support@webhyte.com">support@webhyte.com</a>
                    ...
                    <div class="footer-form" data-form-type="signup_form">
                        <form class="leadForm" id="regForm" method="post" enctype="multipart/form-data" action="form.php">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="name_new" id="name" minlength="2" placeholder="Enter Your Name" data-validation="required" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="email_new" id="email" placeholder="Email Address" data-validation="required" required>
                            </div>
                            <div class="form-group">
                                <input id="" type="phone" class="form-control " maxlength="10"  id="phone" name="phone_new" placeholder="Phone Number"  data-validation="required" required>
                            </div>
                            <div class="form-group">
                        <button type="submit" class="btn-style-2 " name="submit"><span class="moving-circle"></span>Send Message</button>                                <div id="formResult"></div>
                            </div>
                        </form>
                    </div>               
                </div>
